...
class Libraryfunctions(object):
    ...
    def __init__(self):
        ...
        self.ProjectFolder = os.path.join('Projects')
        self.StaticFolder = os.path.join('static')
    ...
    def DeleteProject(self, project):
        #print('rm {} -r'.format(os.path.join(self.ProjectFolderPath, project)))
        print(os.listdir(self.ProjectFolderPath))
        os.popen('rm {} -r'.format(os.path.join(self.ProjectFolderPath, project)))
        print(os.listdir(self.ProjectFolderPath))
